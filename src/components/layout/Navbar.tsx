          ...
          <div className="flex items-center">
            <Link href="/" className="flex items-center gap-3">
              ...
              <div className="flex flex-col">
                <span className="text-xl font-bold tracking-tight text-nipro-blue">{settings?.name?.split(' ')[0] || "NIPRO"}</span>
                <span className="text-[10px] font-medium uppercase tracking-widest text-nipro-red">{settings?.name?.split(' ').slice(1).join(' ') || "Computer Education"}</span>
              </div>
            </Link>
          </div>
